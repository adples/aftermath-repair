	...
	!function (e, n, t) {
	  ...
	  function s() {
	    ...
	    for (var l in f) if (f.hasOwnProperty(l)) {
	      ...
	      for (o = a(n.fn, "function") ? n.fn() : n.fn, s = 0; s < e.length; s++) i = e[s], r = i.split("."), 1 === r.length ? Modernizr[r[0]] = o : (!Modernizr[r[0]] || Modernizr[r[0]] instanceof Boolean || (Modernizr[r[0]] = new Boolean(Modernizr[r[0]])), Modernizr[r[0]][r[1]] = o), d.push((o ? "" : "no-") + r.join("-"));
	    }
	  }
	  function i() {
	  ...
	  c.mq = m, Modernizr.addTest("mediaqueries", m("only all")), s(), o(d), delete c.addTest, delete c.addAsyncTest;
